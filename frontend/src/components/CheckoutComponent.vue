    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col m8">
          <div class="card">
            <div class="card-body">
              <p v-if="cartEmpty" style="padding: 20px">Giỏ hàng trống.</p>
              <form v-else v-if="!cartEmpty">
                ...
                <div class="input-field col m6">
                  <textarea id="address" name="address" class="materialize-textarea" required
            ...
            <div class="card-footer" v-if="!cartEmpty">
              <div class="row">
                <div class="col offset-m6 m6">
                  <button type="button" class="waves-effect waves-light btn offset-m2" v-on:click="cashOnDelivery"
                    style="margin-top: 20px" v-bind:disabled="paymentLoading">
                    Đặt hàng ngay
                  </button>
                </div>
              </div>
