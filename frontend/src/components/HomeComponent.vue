<template>
  <div class="section no-pad-bot" id="index-banner">
    <div class="container-fluid">
      <br /><br />
      <h1 class="header center pink-text">CỬA HÀNG CHO THUÊ SÁCH LBOOK</h1>
      <!-- <div class="row center">
        <h5 class="header col s12 light">Your bracelet here</h5>
      </div> -->
      <br /><br />
        ...
        <div class="col offset-m8 m4">
          <div class="input-field col s12">
            <select v-on:change="onchangeSortBy">
              <option value="newestToOldest">Sách mới</option>
              <option value="oldestToNewest">Sách cũ</option>
        ...
        <div class="col m1">
          <div class="card">
            <div class="card-body" style="
                ...
                padding-left: 20px;
              ">
              <p style="cursor: pointer" v-on:click="onclickCategory">Danh mục sách:</p>
            </div>
          </div>
            ...
            <div class="col m4" v-for="product in products" v-bind:key="product._id">
              <div class="card blue-grey darken-1">
                <div class="card-content white-text">
                  <img v-if="product.images.length > 0" v-bind:src="this.$apiURL + '/' + product.images[0]"
                ...
                <div class="card-action">
                  <router-link v-bind:to="'/product/' + product._id">Xem chi tiết...</router-link>

                  <span style="float: right; color: white">Tồn kho: <span
      ...
      <div class="row">
        <div class="col offset-m6 m4">
          <button type="button" class="waves-effect waves-light btn" v-on:click="loadMore" ref="btnLoadMore">
            Tải thêm...
          </button>
        </div>
      </div>
