    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col m6">
          <div class="carousel">
            ...
            <a class="carousel-item" href="#one!" v-for="(image, index) in product.images">
              <img v-bind:src="this.$apiURL + '/' + image" style="width: 350px" />
            </a>
          </div>
        </div>
        ...
        <div class="col m6">
          ...
          <button v-if="isInCart" type="button" class="waves-effect waves-light btn" v-on:click="removeFromCart">
            Remove from cart
          </button>
          <button v-else type="button" class="waves-effect waves-light btn" v-on:click="addToCart">
            Add to cart
          </button>
        </div>
      </div>
