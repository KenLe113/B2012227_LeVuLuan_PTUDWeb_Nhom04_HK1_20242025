            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bolder">Danh mục sách</h4>
                    </div>
                            ...
                            <table class="table align-items-center justify-content-center mb-0" id="products-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary opacity-7">Tồn kho</th>
                                ...
                                <tbody>
                                    <tr v-for="(product) in products" v-bind:key="product._id.toString()">
                                        ...
                                        <td>
                                            <router-link v-bind:to="'/product/edit/' + product._id"
                                            ...
                                            <form v-on:submit.prevent="deleteProduct">
                                                ...
                                                <input type="submit" name="submit"
                                                    class="btn btn-xs bg-gradient-primary" value="Xóa" />
                                            </form>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="card-footer">
                        <button type="button" v-on:click="loadMore"
                            class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" ref="btnLoadMore">Tải thêm...
                        </button>
                    </div>
                </div>
            </div>
