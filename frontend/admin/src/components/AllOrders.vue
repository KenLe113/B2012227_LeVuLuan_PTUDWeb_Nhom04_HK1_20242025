            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bolder">Danh sách khách hàng mượn sách</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0" id="table">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-secondary opacity-7">Tên khách hàng</th>
                                        <th class="text-uppercase text-secondary opacity-7">Địa chỉ</th>
                                        <th class="text-uppercase text-secondary opacity-7">Tổng</th>
                                        <th class="text-uppercase text-secondary opacity-7">Phương thức thanh toán</th>
                                        <th class="text-uppercase text-secondary opacity-7">Trạng thái</th>
                                        <th class="text-uppercase text-secondary opacity-7">Hành động</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <tr v-for="(order) in orders" v-bind:key="order._id.toString()">
                                        ...
                                        <td>
                                            <span v-if="order.paidVia == 'COD'" style="color: black;">Thanh toán tiền
                                                mặt</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <form
                                                v-if="typeof order.status == 'undefined' || order.status == 'Processing'"
                                                v-on:submit.prevent="markAsCompleted">
                                                <input type="hidden" name="_id" v-bind:value="order._id" required />

                                                <input type="submit" name="submit" value="Đã trả sách"
                    ...
                    <div class="card-footer">
                        <button type="button" v-on:click="loadMore"
                            class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" ref="btnLoadMore">
                            Tải thêm...</button>
                    </div>
                </div>
            </div>
