    ...
    <div class="container-fluid py-4" v-if="order != null">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="font-weight-bolder">Chi tiết hóa đơn mượn sách</h2>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0" id="table">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-secondary opacity-7">Tên sách</th>
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="font-weight-bolder">Thông tin khách hàng</h2>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <span v-if="order.paidVia == 'COD'" style="color: black;">Thanh toán tiền mặt</span>
